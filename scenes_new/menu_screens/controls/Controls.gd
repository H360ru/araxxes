...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
extends ui_screen#VBoxContainer
...
var ActionBind:PackedScene = preload("res://UI/ReBindSection/ActionBind.tscn")
var ControlBind:PackedScene = preload("res://UI/ReBindSection/ControlBind.tscn")
...
func add_control(Name)->void:
	...
	SettingsControls.changed = true #UI UTIL PROPERTY
...
#	MenuEvent.Controls = false
	if SettingsControls.changed:
		get_parent().wait_popup_for('save_and_back', ['Сохранить'])#['confirmed'])
	else:
		get_parent()._back()
