...
const BUTTON_SCENE: PackedScene = preload("res://UI/addons/rich_text_editor/interface/Button.tscn")
const INTERFACE_SCENE: PackedScene = preload("res://UI/addons/rich_text_editor/interface/RichEditorInterface.tscn")
