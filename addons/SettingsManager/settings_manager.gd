extends Node
# TODO: #14 Класс обработки примененных настроек
...
#TODO: #33 подумать над рефакторингом
var changed: bool = false

#TODO: #35 ближе к альфе добавить сейвам версию и грамотный обработчик конфликтов
...
func get_settings() -> Dictionary:
	...
	#TODO: #34 возможно следует как-то иначе сделать логику постобработки сейва
